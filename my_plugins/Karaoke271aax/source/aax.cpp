...
AAX_MIDI_Desc effMIDI[] = {{"Karaoke271", 0xffff}, {nullptr}};
#endif

AAX_Meter_Desc effMeters[] = {};

AAX_Plugin_Desc effPlugins[] = {
    {"com.tqaudio.karaoke271.mono", "Karaoke271", CCONST('D', 'L', 'Y', '1'),
     CCONST('D', 'L', 'A', '1'), 1, 1, 0, effMIDI, nullptr, effMeters, 0},
    {"com.tqaudio.karaoke271.stereo", "Karaoke271", CCONST('D', 'L', 'Y', '2'),
...
AAX_Effect_Desc *AAXWrapper_GetDescription() {
  memcpy(effDesc.mVST3PluginID, (const char *)Karaoke271::ProcessorID,
